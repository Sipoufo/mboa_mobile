...
// tests for PageResponseAnnonceResponse
void main() {
  final instance = PageResponseAnnonceResponseBuilder();
  // TODO add properties to the builder and call build()

  group(PageResponseAnnonceResponse, () {
    // BuiltList<AnnonceResponse> content
