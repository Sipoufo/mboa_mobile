...
[**listBookableSlots**](VisitesApi.md#listbookableslots) | **GET** /api/v1/visites/slots | The assigned agent&#39;s free slots over the next 7 days; an empty list carries a reason
...
# **listBookableSlots**
> BookableSlotsResponse listBookableSlots(annonceId)
...
[**BookableSlotsResponse**](BookableSlotsResponse.md)
