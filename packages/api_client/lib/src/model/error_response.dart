...
/// * [timestamp] 
/// * [status] 
/// * [error] - Stable machine-readable code — clients branch on this
/// * [message] 
/// * [path] 
/// * [fields] 
@BuiltValue()
abstract class ErrorResponse implements Built<ErrorResponse, ErrorResponseBuilder> {
  ...
  BuiltList<FieldError>? get fields;
...
class _$ErrorResponseSerializer implements PrimitiveSerializer<ErrorResponse> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.fields != null) {
      ...
      yield serializers.serialize(
        object.fields,
        specifiedType: const FullType(BuiltList, [FullType(FieldError)]),
      );
    }
  }
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'fields':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(BuiltList, [FullType(FieldError)]),
          ) as BuiltList<FieldError>?;
          if (valueDes == null) continue;
