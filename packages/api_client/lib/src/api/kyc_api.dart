...
class KYCApi {
  ...
  Future<Response<KycStatusResponse>> submitKyc({ 
    ...
    try {
      const _type = FullType(SubmitKycRequest);
      _bodyData = _serializers.serialize(submitKycRequest, specifiedType: _type);
