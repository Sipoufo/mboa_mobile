...
class PrestataireVisitesApi {

  final Dio _dio;

  final Serializers _serializers;

  const PrestataireVisitesApi(this._dio, this._serializers);
  ...
  Future<Response<VisiteResponse>> confirmVisiteRequest({ 
    required String id,
    ...
    final _path = r'/api/v1/prestataires/me/visites/{id}/confirm'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
  ...
  /// Returns a [Future] containing a [Response] with a [VisiteResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<VisiteResponse>> declineVisiteRequest({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/prestataires/me/visites/{id}/decline'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PageResponseVisiteResponse>> listMyOwnerVisites({ 
    ...
    final _path = r'/api/v1/prestataires/me/visites';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
