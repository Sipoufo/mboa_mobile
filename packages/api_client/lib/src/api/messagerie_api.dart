...
class MessagerieApi {
  ...
  const MessagerieApi(this._dio, this._serializers);
  ...
  Future<Response<PageResponseMessageResponse>> listMessages({ 
    ...
    final _path = r'/api/v1/conversations/{id}/messages'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    ...
    PageResponseMessageResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PageResponseMessageResponse),
      ) as PageResponseMessageResponse;
    ...
    return Response<PageResponseMessageResponse>(
      data: _responseData,
  ...
  Future<Response<PageResponseConversationResponse>> listMine1({ 
    ...
    PageResponseConversationResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PageResponseConversationResponse),
      ) as PageResponseConversationResponse;
    ...
    return Response<PageResponseConversationResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<void>> markRead({ 
    ...
    final _path = r'/api/v1/conversations/{id}/read'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<ConversationResponse>> start({ 
    ...
    try {
      const _type = FullType(StartConversationRequest);
      _bodyData = _serializers.serialize(startConversationRequest, specifiedType: _type);
    ...
    ConversationResponse? _responseData;
