...
class AdminKYCApi {
  ...
  const AdminKYCApi(this._dio, this._serializers);
  ...
  Future<Response<KycStatusResponse>> approveKycSubmission({ 
    required String id,
    ...
    final _path = r'/api/v1/admin/kyc/{id}/approve'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    ...
    KycStatusResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(KycStatusResponse),
  ...
  Future<Response<PageResponseKycReviewItem>> listPendingKycSubmissions({ 
    ...
    final _path = r'/api/v1/admin/kyc';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    PageResponseKycReviewItem? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PageResponseKycReviewItem),
      ) as PageResponseKycReviewItem;
    ...
    return Response<PageResponseKycReviewItem>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [KycStatusResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<KycStatusResponse>> rejectKycSubmission({ 
    required String id,
    ...
    final _path = r'/api/v1/admin/kyc/{id}/reject'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(RejectKycRequest);
      _bodyData = _serializers.serialize(rejectKycRequest, specifiedType: _type);
