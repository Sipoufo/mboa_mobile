...
class AuthenticationApi {
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> registerProfessional({ 
    required RegisterProfessionalRequest registerProfessionalRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/auth/register/professional';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(RegisterProfessionalRequest);
      _bodyData = _serializers.serialize(registerProfessionalRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [AuthTokens] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthTokens>> socialLogin({ 
    ...
    final _path = r'/api/v1/auth/social/login';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(SocialLoginRequest);
      _bodyData = _serializers.serialize(socialLoginRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [AuthTokens] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthTokens>> verifyLoginOtp({ 
    required LoginOtpRequest loginOtpRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/auth/login/verify';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(LoginOtpRequest);
      _bodyData = _serializers.serialize(loginOtpRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [AuthTokens] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthTokens>> verifyOtp({ 
