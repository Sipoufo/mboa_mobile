...
class VisitesApi {
  ...
  const VisitesApi(this._dio, this._serializers);
  ...
  Future<Response<VisiteResponse>> bookVisite({ 
    required BookVisiteRequest bookVisiteRequest,
    ...
    try {
      const _type = FullType(BookVisiteRequest);
      _bodyData = _serializers.serialize(bookVisiteRequest, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> cancelMyVisite({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/visites/{id}/cancel'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BookableSlotsResponse>> listBookableSlots({ 
    ...
    final _path = r'/api/v1/visites/slots';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      r'annonceId': encodeQueryParameter(_serializers, annonceId, const FullType(String)),
    };
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PageResponseVisiteResponse>> listMyVisites({ 
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> rateVisiteAgent({ 
    required String id,
    required RateAgentRequest rateAgentRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/visites/{id}/rating'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(RateAgentRequest);
      _bodyData = _serializers.serialize(rateAgentRequest, specifiedType: _type);
