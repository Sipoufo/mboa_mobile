...
class LocationsApi {
  ...
  Future<Response<BuiltList<LocationOption>>> listCities({ 
    ...
    final _path = r'/api/v1/locations/cities';
    ...
    final _queryParameters = <String, dynamic>{
      if (regionId != null) r'regionId': encodeQueryParameter(_serializers, regionId, const FullType(String)),
    };
    ...
    BuiltList<LocationOption>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(LocationOption)]),
      ) as BuiltList<LocationOption>;
    ...
    return Response<BuiltList<LocationOption>>(
      data: _responseData,
  ...
  Future<Response<BuiltList<CountryResponse>>> listCountries({ 
    ...
    final _path = r'/api/v1/locations/countries';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(CountryResponse)]),
  ...
  Future<Response<BuiltList<LocationOption>>> listDistricts({ 
    ...
    final _path = r'/api/v1/locations/cities/{cityId}/districts'.replaceAll('{' r'cityId' '}', encodeQueryParameter(_serializers, cityId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<LocationOption>>> listRegions({ 
    ...
    final _path = r'/api/v1/locations/regions';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
