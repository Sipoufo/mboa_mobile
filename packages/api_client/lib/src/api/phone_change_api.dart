...
class PhoneChangeApi {

  final Dio _dio;

  final Serializers _serializers;

  const PhoneChangeApi(this._dio, this._serializers);
  ...
  Future<Response<PhoneChangeResponse>> confirmPhoneChange({ 
    ...
    final _path = r'/api/v1/account/phone/verify';
    ...
    PhoneChangeResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PhoneChangeResponse),
      ) as PhoneChangeResponse;
    ...
    return Response<PhoneChangeResponse>(
      data: _responseData,
  ...
  Future<Response<void>> requestPhoneChange({ 
    ...
    final _path = r'/api/v1/account/phone/change';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(RequestPhoneChangeRequest);
      _bodyData = _serializers.serialize(requestPhoneChangeRequest, specifiedType: _type);
