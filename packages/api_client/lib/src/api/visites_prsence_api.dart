...
class VisitesPrsenceApi {

  final Dio _dio;

  final Serializers _serializers;

  const VisitesPrsenceApi(this._dio, this._serializers);
  ...
  Future<Response<VisiteResponse>> confirmVisitorPresence({ 
    required String id,
    ...
    final _path = r'/api/v1/visites/{id}/visitor-confirmation'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
