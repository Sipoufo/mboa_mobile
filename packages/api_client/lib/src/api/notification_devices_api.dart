...
class NotificationDevicesApi {
  ...
  const NotificationDevicesApi(this._dio, this._serializers);
  ...
  Future<Response<void>> unregisterDevice({ 
    ...
    final _path = r'/api/v1/notifications/devices/{token}'.replaceAll('{' r'token' '}', encodeQueryParameter(_serializers, token, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
