...
class AnnoncesApi {
  ...
  const AnnoncesApi(this._dio, this._serializers);
  ...
  Future<Response<AnnonceResponse>> archiveAnnonce({ 
    ...
    final _path = r'/api/v1/annonces/{id}/archive'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    ...
    AnnonceResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AnnonceResponse),
      ) as AnnonceResponse;
    ...
    return Response<AnnonceResponse>(
      data: _responseData,
  ...
  Future<Response<AnnonceResponse>> createAnnonce({ 
    ...
    try {
      const _type = FullType(CreateAnnonceRequest);
      _bodyData = _serializers.serialize(createAnnonceRequest, specifiedType: _type);
  ...
  Future<Response<void>> deleteAnnonce({ 
    ...
    final _path = r'/api/v1/annonces/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PageResponseAnnonceResponse>> listMyAnnonces({ 
    ...
    PageResponseAnnonceResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PageResponseAnnonceResponse),
      ) as PageResponseAnnonceResponse;
    ...
    return Response<PageResponseAnnonceResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AnnonceResponse>> markAnnonceRented({ 
    ...
    final _path = r'/api/v1/annonces/{id}/rented'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<AnnonceResponse>> publishAnnonce({ 
    ...
    final _path = r'/api/v1/annonces/{id}/publish'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<AnnonceResponse>> reserveAnnonce({ 
    ...
    final _path = r'/api/v1/annonces/{id}/reserve'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<AnnonceResponse>> unarchiveAnnonce({ 
    ...
    final _path = r'/api/v1/annonces/{id}/unarchive'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<AnnonceResponse>> updateAnnonce({ 
    ...
    try {
      const _type = FullType(UpdateAnnonceRequest);
      _bodyData = _serializers.serialize(updateAnnonceRequest, specifiedType: _type);
