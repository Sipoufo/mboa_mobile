...
class AdminTypeChangeApi {

  final Dio _dio;

  final Serializers _serializers;

  const AdminTypeChangeApi(this._dio, this._serializers);
  ...
  Future<Response<TypeChangeReviewResult>> approve({ 
    ...
    final _path = r'/api/v1/admin/type-change-requests/{id}/approve'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    ...
    TypeChangeReviewResult? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TypeChangeReviewResult),
      ) as TypeChangeReviewResult;
    ...
    return Response<TypeChangeReviewResult>(
      data: _responseData,
  ...
  Future<Response<PageResponseTypeChangeReviewItem>> listPending({ 
    ...
    final _path = r'/api/v1/admin/type-change-requests';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    PageResponseTypeChangeReviewItem? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PageResponseTypeChangeReviewItem),
      ) as PageResponseTypeChangeReviewItem;
    ...
    return Response<PageResponseTypeChangeReviewItem>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<TypeChangeReviewResult>> reject({ 
    ...
    final _path = r'/api/v1/admin/type-change-requests/{id}/reject'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(RejectTypeChangeRequest);
      _bodyData = _serializers.serialize(rejectTypeChangeRequest, specifiedType: _type);
