...
class ResidencesApi {
  ...
  const ResidencesApi(this._dio, this._serializers);
  ...
  Future<Response<ResidenceResponse>> archiveAll({ 
    ...
    final _path = r'/api/v1/residences/{id}/archive'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    ...
    ResidenceResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ResidenceResponse),
      ) as ResidenceResponse;
    ...
    return Response<ResidenceResponse>(
      data: _responseData,
  ...
  Future<Response<ResidenceResponse>> create({ 
    ...
    final _path = r'/api/v1/residences';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CreateResidenceRequest);
      _bodyData = _serializers.serialize(createResidenceRequest, specifiedType: _type);
  ...
  Future<Response<void>> delete({ 
    ...
    final _path = r'/api/v1/residences/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PageResponseResidenceResponse>> listMine({ 
    ...
    PageResponseResidenceResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PageResponseResidenceResponse),
      ) as PageResponseResidenceResponse;
    ...
    return Response<PageResponseResidenceResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ResidenceResponse>> publishAll({ 
    ...
    final _path = r'/api/v1/residences/{id}/publish'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<ResidenceResponse>> rentAll({ 
    ...
    final _path = r'/api/v1/residences/{id}/rented'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<ResidenceResponse>> reserveAll({ 
    ...
    final _path = r'/api/v1/residences/{id}/reserve'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<ResidenceResponse>> unarchiveAll({ 
    ...
    final _path = r'/api/v1/residences/{id}/unarchive'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<ResidenceResponse>> update({ 
    ...
    try {
      const _type = FullType(UpdateResidenceRequest);
      _bodyData = _serializers.serialize(updateResidenceRequest, specifiedType: _type);
