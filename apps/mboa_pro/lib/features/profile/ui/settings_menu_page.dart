...
/// Route adapter for the shared "Paramètres" menu. Change phone / password
/// entries are wired in a following step.
@RoutePage()
class SettingsMenuPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => SettingsMenuView(
        ...
        onChangePassword: () => context.router.push(const ChangePasswordRoute()),
