...
import 'package:mboa_pro/features/visits/ui/visit_review_page.dart' as _i38;
...
class PrestataireVisitsRoute extends _i39.PageRouteInfo<void> {
  const PrestataireVisitsRoute({List<_i39.PageRouteInfo>? children})
  ...
  static _i39.PageInfo page = _i39.PageInfo(
    name,
    builder: (data) {
      return _i39.WrappedRoute(child: const _i26.PrestataireVisitsPage());
    },
  );
}
...
/// generated route for
/// [_i38.VisitReviewPage]
class VisitReviewRoute extends _i39.PageRouteInfo<VisitReviewRouteArgs> {
  VisitReviewRoute({
    _i40.Key? key,
    required String id,
...
class VisitReviewRouteArgs {
  ...
  @override
  String toString() {
    return 'VisitReviewRouteArgs{key: $key, id: $id, propertyTitle: $propertyTitle}';
  }
}
